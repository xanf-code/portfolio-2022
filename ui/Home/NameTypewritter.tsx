...
function NameTypewritter() {
    return (
        <div className="flex-1 flex flex-col w-full">
            ...
            <p className="text-sm tracking-wider text-justify leading-6">I'm developing myself on learning Software Architecture, Clean Code, Design Patterns, Devops, Designs and all that cliché computer stuff. I enjoy expressing myself through designs and code that's why I created my
