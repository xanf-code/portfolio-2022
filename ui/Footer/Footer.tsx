...
const getNowPlayingSong = async () => {
  // Replace by real URL later on
  const { data } = await axios.get("/api/spotifynow");
  return data;
};

export default function Footer(props) {
  const { data } = useQuery("spotify", getNowPlayingSong, {
  ...
  return (
    <footer className="flex flex-col justify-center max-w-2xl mx-auto w-full mb-8">
      ...
      <div className="mt-5">
        ...
        <div className="flex pt-8 space-x-6">
          <a href="https://twitter.com/darshanaswath__" target="_blank">
            <div className="flex space-x-2 items-center text-center hover:underline">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
          ...
          <a href="https://github.com/xanf-code" target="_blank">
            <div className="flex space-x-2 items-center text-center hover:underline">
              ...
              <h1 className="text-sm font-medium text-gray-500 dark:text-gray-400 pt-0.5">
                Github
              </h1>
            </div>
          </a>
      ...
      <h1 className="text-sm font-Quattro pt-8 md:pt-6 items-center">
        <Emoji /> {moment().format("dddd")},2022 - Darshan |{" "}
        <a href="https://github.com/xanf-code/portfolio-2022" target="_blank">
...
function Linker({ text, href }) {
  return (
    <Link href={href}>
      <a>
        <h1 className="text-sm font-medium text-gray-500 dark:text-gray-400 hover:underline pt-4">
          {text}
        </h1>
      </a>
    </Link>
