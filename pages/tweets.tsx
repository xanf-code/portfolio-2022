        ...
        <Layout title="Tweets | Darshan Aswath">
            <div className="flex flex-col justify-center items-start max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pb-16">
                ...
                <div className='w-full pb-1'>
                    <a className='text-right hover:dark:text-blue-500 hover:text-blue-500 transform ease-in duration-200 pb-1 dark:text-gray-400' href="https://github.com/xanf-code/portfolio-2022/tree/main/data/tweets.tsx" target="_blank">
